...
// ---------------------------------------------------------------------------
// Plugin System — see docs/extensions/index.en.md for the canonical overview
// ---------------------------------------------------------------------------
 ...
 *
 * @see docs/extensions/index.en.md §4 — Versioning
 */
 ...
 * @see docs/extensions/index.en.md §21.3 `plugins.status`
 */
 ...
 *
 * @see docs/extensions/index.en.md §6.2
 */
 ...
 *
 * @see docs/extensions/index.en.md §21.3 `plugin_state.scope_kind`
 */
...
export const PLUGIN_EVENT_TYPES = [
  ...
  "system_issue.created",
  "system_issue.updated",
  "system_issue.routed",
  "system_issue.block_recommendation_updated",
  "agent.created",
  "agent.updated",
  ...
  "department.frozen",
  "department.unfrozen",
  "temporary_worker.created",
  "temporary_worker.pause_requested",
  "temporary_worker.resume_requested",
  "temporary_worker.resume_approved",
  "temporary_worker.ttl_extended",
  "temporary_worker.terminated",
  "temporary_worker.ttl_reconciled",
  "goal.created",
  "goal.updated",
  "approval.created",
  "approval.decided",
...
export {
  ...
  BOARD_ASSISTANT_BINDING_SESSION_STATUSES,
  BOARD_ASSISTANT_ONBOARDING_SESSION_STATUSES,
  BOARD_ASSISTANT_THREAD_KINDS,
  BOARD_ASSISTANT_THREAD_MODES,
  BOARD_ASSISTANT_THREAD_MESSAGE_AUTHOR_KINDS,
  BOARD_ASSISTANT_THREAD_MESSAGE_DIRECTIONS,
  BOARD_ASSISTANT_REQUEST_STATUSES,
  BOARD_ASSISTANT_TARGET_STATUSES,
  BOARD_ASSISTANT_OUTBOX_STATUSES,
  BOARD_ASSISTANT_TARGET_KINDS,
  ...
  BOARD_ASSISTANT_BLOCKED_REASONS,
  BOARD_ASSISTANT_INSTANCE_ACTIONS,
  BOARD_ASSISTANT_AUTO_EXECUTION_MODES,
} from "./constants/board-assistant.js";
export type {
...
export {
  ...
  SYSTEM_PLUGIN_ROLLOUT_KINDS,
  SYSTEM_PLUGIN_ROLLOUT_STATUSES,
  SYSTEM_PLUGIN_ROLLOUT_APPROVAL_DECISIONS,
  SYSTEM_PLUGIN_ROLLOUT_COMMAND_KINDS,
} from "./constants/rollout.js";
export type {
