...
export function Issues() {
  ...
  const issueLinkState = useMemo(
    () =>
      createIssueDetailLocationState(
        t("breadcrumbs.issues", { defaultValue: "Issues" }),
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("breadcrumbs.issues", { defaultValue: "Issues" }) }]);
  }, [setBreadcrumbs, t]);
  ...
  if (!selectedCompanyId) {
    return (
      <EmptyState
        icon={CircleDot}
        message={t("empty.selectCompany", { defaultValue: "Select a company to view issues." })}
      />
    );
  }
