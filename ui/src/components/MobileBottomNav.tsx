...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("common:navigation.dashboard"), icon: House },
      { type: "link", to: "/issues", label: t("common:navigation.issues"), icon: CircleDot },
      { type: "action", label: t("common:actions.newIssue"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("common:navigation.agents", { defaultValue: "Agents" }), icon: Users },
      {
        type: "link",
        to: "/inbox",
  ...
  return (
    <nav
      ...
      aria-label={t("common:navigation.mobile", { defaultValue: "Mobile navigation" })}
    >
