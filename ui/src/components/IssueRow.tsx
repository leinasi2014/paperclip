...
export function IssueRow({
  ...
  const markAsReadLabel = t("row.actions.markAsRead", { defaultValue: "Mark as read" });
  const dismissFromInboxLabel = t("row.actions.dismissFromInbox", { defaultValue: "Dismiss from inbox" });
        ...
        <span className="inline-flex h-4 w-4 shrink-0 items-center justify-center self-center">
          {showUnreadDot ? (
            ...
            <button
              ...
              aria-label={dismissFromInboxLabel}
            >
